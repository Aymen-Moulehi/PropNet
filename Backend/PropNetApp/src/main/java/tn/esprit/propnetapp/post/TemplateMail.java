...
public class TemplateMail {
    ...
    public static String ContentMailToRecipient (String RecipientName,Integer id){
        String template = "<body style=\"margin: 0; padding: 0;\" bgcolor=\"#eaeced\">\n"
                ...
                + "                <tr>\n"
                + "                  <td class=\"img-flex\">\n"
                + "                    <img src=\"https://upload.wikimedia.org/wikipedia/commons/thumb/3/32/Post_Holdings_logo.svg/1200px-Post_Holdings_logo.svg.png\" style=\"vertical-align: top;\" width=\"600\" height=\"249\" alt=\"\" />\n"
                + "                  </td>\n"
                + "                </tr>\n"
                + "                <tr>\n"
                ...
                + "                          Dear " + RecipientName + ",\nCongratulations your post approved!\n"
                + "                        </td>\n"
                + "                      </tr>\n"
                + "                      <tr>\n"
                ...
                + "                          Get ready to be informed and inspired as you explore a world of knowledge with our approved posts \n"
                + "                        </td>\n"
                + "                      </tr>\n"
                + "                      <tr>\n"
                + "                        <td data-color=\"text\" data-size=\"size text\" data-min=\"10\" data-max=\"26\" data-link-color=\"link text color\" data-link-style=\"font-weight:bold; text-decoration:underline; color:#40aceb;\" align=\"center\" style=\"font: 16px/29px Arial, Helvetica, sans-serif; color: #888; padding: 0 0 21px;\">\n"
                ...
                + "                                    <a target=\"_blank\" style=\"text-decoration:none; color:#f8f9fb; display:block; padding:12px 10px 10px;\" href=\"http://localhost:4200/forume/detail;idPost=" + id + "\">Learn More</a>\n"
                + "                                  </td>\n"
                + "                                </tr>\n"
                + "                              </table>\n"
                + "                            </td>\n"
